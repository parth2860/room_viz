...
#include "room_vizCharacter.generated.h"
...
UCLASS(config=Game)
class Aroom_vizCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class UUIUserWidget> UIWidgetClass;
